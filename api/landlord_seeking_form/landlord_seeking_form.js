...
const URL_seeking_typeform_elastic_map = require('../mapping_locations').getMaps().URL_seeking_typeform_elastic_map
const headers = {
  headers: {
...
exports.process_seeking_form = function(typeform) {
  const p = new Promise((res, rej) => {
    axios.get(URL_seeking_typeform_elastic_map, headers)
      .then((seeking_typeform_elastic_map) => {
        if (verifyCorrectForm(typeform, seeking_typeform_elastic_map.data)) {
          /*
